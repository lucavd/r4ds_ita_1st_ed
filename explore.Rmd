...
-   La visualizzazione è un ottimo punto di partenza per la programmazione in R, perché il guadagno è palese: si possono fare grafici eleganti e informativi che aiutano a capire i dati. In \[data visualization\] vi immergerete nella visualizzazione, imparando la struttura di base di una trama ggplot2, e potenti tecniche per trasformare i dati in grafici.

-   La sola visualizzazione di solito non è sufficiente, quindi in \[data transformation\] imparerete i verbi chiave che vi permettono di selezionare le variabili importanti, filtrare le osservazioni chiave, creare nuove variabili e calcolare le sintesi.

-   Infine, in \[analisi esplorativa dei dati\], combinerai la visualizzazione e la trasformazione con la tua curiosità e il tuo scetticismo per chiedere e rispondere domande interessanti sui dati.
